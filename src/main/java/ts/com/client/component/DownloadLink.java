...
public class DownloadLink extends HorizontalPanel {
    ...
    public DownloadLink(File file) {
        ...
        btnRemove.getElement().addEventListener(Client.CLICK, e->onBtnRemove());
    ...
    public void onBtnRemove(){
        Alerts.confirm("Desea eliminar el recurso seleccionado?", ()->{
            String path = Server.PATH_WEBAPPS + "/files/" + anchor.getText();
