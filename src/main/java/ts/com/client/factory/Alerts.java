...
public class Alerts {
    ...
    public static PanelView warning(String message) {
    ...
    public static PanelView warning(String message, CloseHandler handler) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "green");
    ...
    public static PanelView info(String message) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "green");
    ...
    public static PanelView info(String message, CloseHandler handler) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "green");
    ...
    public static PanelView infoSaved() {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "green");
        return showDialog(icon, "Mensaje", "Datos grabados exitosamente", TYPE_MESSAGE, null);
    }

    public static PanelView infoSaved(CloseHandler handler) {
        Icon icon = VaadinIcon.CIRCLE.create();
    ...
    public static PanelView error(String message) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "red");
    ...
    public static PanelView error(String message, CloseHandler handler) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "red");
     ...
     */
    public static PanelView confirm(String message, CloseHandler handler) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "orange");
        return showDialog(icon, "Confirmacion", message, TYPE_CONFIRM, null, null, handler);
    }

    public static PanelView confirmSave(CloseHandler handler) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "orange");
        return showDialog(icon, "Confirmacion", "Desea Grabar los Datos Ingresados?", TYPE_CONFIRM, null, null, handler);
    }

    public static PanelView prompt(String message, TextBox txtPrompt, CloseHandler handler) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "orange");
        txtPrompt.focus();
    ...
    public static PanelView prompt(String message, PasswordTextBox txtPass, CloseHandler handler) {
        Icon icon = VaadinIcon.CIRCLE.create();
        icon.getStyle().set("color", "orange");
        return showDialog(icon, "Ingresar", message, TYPE_CONFIRM, null, txtPass, handler);
    }

    private static PanelView showDialog(Icon icon, String header, String message, int type,
            CloseHandler handler) {
        return showDialog(icon, header, message, type, null, null, handler);
    }

    private static PanelView showDialog(Icon icon, String header, String message, int type, TextBox txt, PasswordTextBox txtp,
            CloseHandler handler) {
