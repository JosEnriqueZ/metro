...
//import ts.com.service.model.Ubigeo;
//import ts.com.service.model.rrhh.Permiso;
...
//    	//para el ubigeo
//	public static List<Ubigeo> UBIGEOS = new ArrayList<>();
//	
//	public static Ubigeo getDepartamento(Ubigeo ubigeo) {
//
//        for (Ubigeo ubg : UBIGEOS) {
//            if (ubg.departamento.equals(ubigeo.departamento)
//                    && ubg.provincia.equals("00")
//                    && ubg.distrito.equals("00")) {
//                return ubg;
//            }
//        }
//        return null;
//    }
//	
//	public static Ubigeo getDepartamento(String ubigeo) {
//
//        for (Ubigeo ubg : UBIGEOS) {
//            if (ubg.departamento.equals(ubigeo.substring(0, 2))
//                    && ubg.provincia.equals("00")
//                    && ubg.distrito.equals("00")) {
//                return ubg;
//            }
...
//    }
//
//	public static Ubigeo getProvincia(Ubigeo ubigeo) {
//
//        for (Ubigeo ubg : UBIGEOS) {
//            if (ubg.departamento.equals(ubigeo.departamento)
//                    && ubg.provincia.equals(ubigeo.provincia)
//                    && ubg.distrito.equals("00")) {
//                return ubg;
//            }
//        }
...
//    }
//	
//	public static Ubigeo getProvincia(String ubigeo) {
//
//        for (Ubigeo ubg : UBIGEOS) {
//            if (ubg.departamento.equals(ubigeo.substring(0, 2))
//                    && ubg.provincia.equals(ubigeo.substring(2, 4))
//                    && ubg.distrito.equals("00")) {
//                return ubg;
//            }
//        }
...
//    }
//	
//	public static Ubigeo getDistrito(Ubigeo ubigeo) {
//
//        for (Ubigeo ubg : UBIGEOS) {
//            if (ubg.departamento.equals(ubigeo.departamento)
//                    && ubg.provincia.equals(ubigeo.provincia)
//                    && ubg.distrito.equals(ubigeo.distrito)) {
//                return ubg;
//            }
//        }
//        return null;
//    }
//	
//	public static Ubigeo getDistrito(String ubigeo) {
//
//        for (Ubigeo ubg : UBIGEOS) {
//            if (ubg.departamento.equals(ubigeo.substring(0, 2))
//                    && ubg.provincia.equals(ubigeo.substring(2, 4))
//                    && ubg.distrito.equals(ubigeo.substring(4, 6))) {
//                return ubg;
//            }
//        }
//        return null;
...
//			if (ubigeo.provincia.equals("00") && ubigeo.distrito.equals("00")) {
//				list.add(ubigeo);
//			}
//		}
//		return list;
//	}
//
//    public static List<Ubigeo> getProvincias(Ubigeo departamento) {
//        List<Ubigeo> list = new ArrayList<>();
//        for (Ubigeo ubigeo : UBIGEOS) {
//            if (!ubigeo.provincia.equals("00") && ubigeo.distrito.equals("00")) {
//                if (ubigeo.departamento.equals(departamento.departamento)) {
//                    list.add(ubigeo);
//                }
//            }
//        }
...
//    }
//
//    public static List<Ubigeo> getDistritos(Ubigeo provincia) {
//        List<Ubigeo> list = new ArrayList<>();
//        for (Ubigeo ubigeo : UBIGEOS) {
//            if (!ubigeo.provincia.equals("00") && !ubigeo.distrito.equals("00")) {
//                if (ubigeo.departamento.equals(provincia.departamento) && ubigeo.provincia.equals(provincia.provincia)) {
//                    list.add(ubigeo);
//                }
//            }
//        }
